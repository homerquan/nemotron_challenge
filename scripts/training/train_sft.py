...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Run SFT training using Unsloth and Accelerate",
        formatter_class=RichHelpFormatter
    )
    parser.add_argument("--base_model", type=str, default="/home/ubuntu/nemotron_model", help="Path to the base model")
    parser.add_argument("--dataset_path", type=str, default="./reasoning_dataset", help="Path to the formatted dataset")
    parser.add_argument("--output_dir", type=str, default="./nemotron-reasoning-lora", help="Output directory for checkpoints")
...
def main():
    ...
    # Setup resume from checkpoint logic
